...
> Snake animation appears only after the GitHub Action is created and successfully run.
...
> Pac-Man animation also requires a separate GitHub Action. If it does not show, keep the snake only.
